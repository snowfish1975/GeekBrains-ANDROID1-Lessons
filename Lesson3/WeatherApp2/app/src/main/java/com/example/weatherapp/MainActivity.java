...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClick(View view) {
        int[] weatherStates = {1, 100, 101, 110, 111, 1100, 1110, 10100, 10110};
        Random rnd = new Random();
        int weatherStateIndex = rnd.nextInt(9);
        switch (view.getId()) {
            case R.id.button:
                ...
                intent.putExtra("WeatherState",weatherStates[weatherStateIndex]);
